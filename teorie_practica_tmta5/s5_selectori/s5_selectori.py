...
Nodul <head> - este un container pentru metadata si contine titlul paginii, referinte catre fisiere cu scripturi, 
stiluri si altele
...
# In terminal scriem urmatoarele comenzi, unul cate unul, apasand Enter si asteptand sa se instaleze fiecare
...
# Urmatorul exemplu returneaza un singur element (primul gasit)
...
# Urmatorul exemplu ar da click pe al 18-lea element din lista:
# lista_elemente[17].click()
# time.sleep(2)
